...
- [ ] **Step 5: Update `README.md` and `README.zh-CN.md`**
...
```bash
cd ~/Projects/academic-research-skills
git add -A scripts/check_spec_consistency.py academic-pipeline/SKILL.md academic-paper/SKILL.md academic-paper-reviewer/SKILL.md deep-research/SKILL.md .claude/CLAUDE.md README.md README.zh-CN.md
git status
git commit -m "$(cat <<'EOF'
...
section, README EN + zh-CN skill tables. MODE_REGISTRY.md verified
...
- Modify: `docs/PERFORMANCE.zh-CN.md`
...
- [ ] **Step 2: Add equivalent section to zh-CN**

Open `docs/PERFORMANCE.zh-CN.md`. Append equivalent content in Simplified Chinese:
