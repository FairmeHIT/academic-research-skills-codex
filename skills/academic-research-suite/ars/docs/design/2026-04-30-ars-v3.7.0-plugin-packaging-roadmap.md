...
- ❌ Codex CLI：用 `academic-research-skills-codex` fork，不在本 roadmap 范围
...
| Codex CLI 用户误装 plugin | 低 | README 明写「plugin = Claude Code only；Codex 用 academic-research-skills-codex」 |
