...
- **Explicitly untouched:**
  ...
  - All SKILL.md version fields, `MODE_REGISTRY.md`, `.claude/CLAUDE.md` Skills Overview, `README.md`, `README.zh-CN.md`, `CHANGELOG.md` (PR-B scope).
...
6. `README.md` and `README.zh-CN.md` — badge / heading / changelog entry (Chinese version uses full-width parentheses).
