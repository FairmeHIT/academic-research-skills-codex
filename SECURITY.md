...
1. Go to the [Security Advisories](https://github.com/FairmeHIT/academic-research-skills-codex-zh-CH/security/advisories) page.
...
- General installation problems, feature requests, or non-security bugs - use
  [Issues](https://github.com/FairmeHIT/academic-research-skills-codex-zh-CH/issues)
  instead.
